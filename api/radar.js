...
const SYSTEM = [
  ...
  "- Do TWO separate passes and return results from both:",
  "    (a) NEW ALBUMS \u2014 records being released for the first time. Go",
  "        through their most-collected artists and ask what each has",
  "        announced; then look at notable new releases in their genres.",
  "        A new record from an artist they collect is the single most",
  "        wanted result there is.",
  "    (b) REISSUES AND REPRESSINGS of older albums.",
  "  Aim for a real mix. A list of only repressings means pass (a) was not",
  "  done properly \u2014 artists release new records constantly and some of",
  "  theirs will have something due.",
